...
function initConfigSipaes() {
    changeDarkModeCheckbox();
    changeLayoutNavbarCheckbox();
    changeBorderNavbar();
...
function getNavbarLightSkins() {
    return ["navbar-light", "navbar-warning", "navbar-white", "navbar-orange"];
}

function getSidebarColors() {
    return [
        "bg-primary",
        "bg-warning",
        "bg-info",
...
function changeDarkModeCheckbox() {
    const dark_mode_checked = Boolean(parseInt($.cookie("dark_mode_checked")));
    if (dark_mode_checked) {
...
function changeLayoutNavbarCheckbox() {
    const layout_navbar_fixed_checked = Boolean(
        parseInt($.cookie("layout_navbar_fixed_checked"))
    );
    if (layout_navbar_fixed_checked) {
...
function changeBorderNavbar() {
    const no_border_checked = Boolean(parseInt($.cookie("no_border_checked")));
...
function changeSidebarCollapse() {
    const sidebar_collapse_checked = Boolean(
        parseInt($.cookie("sidebar_collapse_checked"))
    );
    if (sidebar_collapse_checked) {
...
function changeSidebarFixed() {
    const sidebar_fixed_checked = Boolean(
        parseInt($.cookie("sidebar_fixed_checked"))
    );
    if (sidebar_fixed_checked) {
...
function changeSidebarMini() {
    const sidebar_mini_checked = Boolean(
        parseInt($.cookie("sidebar_mini_checked"))
    );
    if (sidebar_mini_checked) {
...
function changeSidebarMiniMD() {
    const sidebar_mini_md_checked = Boolean(
        parseInt($.cookie("sidebar_mini_md_checked"))
    );
    if (sidebar_mini_md_checked) {
...
function changeSidebarMiniXS() {
    const sidebar_mini_xs_checked = Boolean(
        parseInt($.cookie("sidebar_mini_xs_checked"))
    );
    if (sidebar_mini_xs_checked) {
...
function initNavbarColor($container) {
    const navbar_dark_skins = getNavbarDarkSkins();
    const navbar_light_skins = getNavbarLightSkins();
    ...
    var $navbar_variants_colors = createSkinBlock(
        navbar_all_colors,
        function () {
            const color = $.cookie("navbar_color");
...
function footerFixed() {
    const footer_fixed_checked = Boolean(
        parseInt($.cookie("footer_fixed_checked"))
    );
    if (footer_fixed_checked) {
...
(function ($) {
    ...
    var $container = $("<div />", {
        class: "p-3 control-sidebar-content bg-danger",
    });
    ...
    $container.append(
        '<h5>Personalización de Aplicación</h5><hr class="mb-2"/>'
    );

    /** Darkmode */
    const cookie_dark_mode_checked = Boolean(
        parseInt($.cookie("dark_mode_checked"))
    );

    var $dark_mode_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_dark_mode_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("dark_mode_checked", 1);
        } else {
            $.cookie("dark_mode_checked", 0);
        }
        changeDarkModeCheckbox();
    });
    ...
    /** Navbar Fixed */
    const cookie_layout_navbar_fixed_checked = Boolean(
        parseInt($.cookie("layout_navbar_fixed_checked"))
    );
    ...
    var $header_fixed_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_layout_navbar_fixed_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("layout_navbar_fixed_checked", 1);
        } else {
            $.cookie("layout_navbar_fixed_checked", 0);
        }
        changeLayoutNavbarCheckbox();
    });
    var $header_fixed_container = $("<div />", { class: "mb-1" })
        .append($header_fixed_checkbox)
        .append("<span>Mantener Barra de Navegación</span>");
    ...
    const cookie_no_border_checked = Boolean(
        parseInt($.cookie("no_border_checked"))
    );
    ...
    var $no_border_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_no_border_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("no_border_checked", 1);
        } else {
            $.cookie("no_border_checked", 0);
        }
        changeBorderNavbar();
    });
    var $no_border_container = $("<div />", { class: "mb-4" })
        .append($no_border_checkbox)
        .append("<span>Sin borde</span>");
    ...
    /** Sidebar Collapse */
    const cookie_sidebar_collapse_checked = Boolean(
        parseInt($.cookie("sidebar_collapse_checked"))
    );
    ...
    var $sidebar_collapsed_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_sidebar_collapse_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("sidebar_collapse_checked", 1);
        } else {
            $.cookie("sidebar_collapse_checked", 0);
        }
        changeSidebarCollapse();
    });
    ...
    var $sidebar_collapsed_container = $("<div />", { class: "mb-1" })
        ...
        .append("<span>Barra Lateral Colapsado</span>");
    ...
    /** Sidebar Fixed */
    const cookie_sidebar_fixed = Boolean(
        parseInt($.cookie("sidebar_fixed_checked"))
    );
    ...
    var $sidebar_fixed_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_sidebar_fixed,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("sidebar_fixed_checked", 1);
        } else {
            $.cookie("sidebar_fixed_checked", 0);
        }
        changeSidebarFixed();
    });
    var $sidebar_fixed_container = $("<div />", { class: "mb-1" })
        .append($sidebar_fixed_checkbox)
        .append("<span>Mantener Barra Lateral</span>");
    $container.append($sidebar_fixed_container);
    /** ./Sidebar Fixed */

    /** Sidebar Mini */
    const cookie_sidebar_mini_checked = Boolean(
        parseInt($.cookie("sidebar_mini_checked"))
    );
    ...
    var $sidebar_mini_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_sidebar_mini_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("sidebar_mini_checked", 1);
        } else {
            $.cookie("sidebar_mini_checked", 0);
        }
        changeSidebarMini();
    });
    var $sidebar_mini_container = $("<div />", { class: "mb-1" })
        .append($sidebar_mini_checkbox)
        .append("<span>Mini Barra Lateral</span>");
    $container.append($sidebar_mini_container);
    /** ./Sidebar Mini */

    /** Sidebar MD */
    const cookie_sidebar_mini_md_checked = Boolean(
        parseInt($.cookie("sidebar_mini_md_checked"))
    );
    ...
    var $sidebar_mini_md_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_sidebar_mini_md_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("sidebar_mini_md_checked", 1);
        } else {
            $.cookie("sidebar_mini_md_checked", 0);
        }
        changeSidebarMiniMD();
    });
    var $sidebar_mini_md_container = $("<div />", { class: "mb-1" })
        .append($sidebar_mini_md_checkbox)
        .append("<span>Mini Barrera Lateral (Mediano)</span>");
    $container.append($sidebar_mini_md_container);
    /** ./Sidebar MD */

    /** Sidebar XS */
    const cookie_sidebar_mini_xs_checked = Boolean(
        parseInt($.cookie("sidebar_mini_xs_checked"))
    );
    ...
    var $sidebar_mini_xs_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_sidebar_mini_xs_checked,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("sidebar_mini_xs_checked", 1);
        } else {
            $.cookie("sidebar_mini_xs_checked", 0);
        }
        changeSidebarMiniXS();
    });
    var $sidebar_mini_xs_container = $("<div />", { class: "mb-1" })
        .append($sidebar_mini_xs_checkbox)
        .append("<span>Mini Barrera Lateral (Pequeño)</span>");
    ...
    /** Footer Fixed */
    const cookie_footer_fixed = Boolean(
        parseInt($.cookie("footer_fixed_checked"))
    );
    ...
    var $footer_fixed_checkbox = $("<input />", {
        type: "checkbox",
        value: 1,
        checked: cookie_footer_fixed,
        class: "mr-1",
    }).on("click", function () {
        if ($(this).is(":checked")) {
            $.cookie("footer_fixed_checked", 1);
        } else {
            $.cookie("footer_fixed_checked", 0);
        }
        footerFixed();
    });
    var $footer_fixed_container = $("<div />", { class: "mb-4" })
        .append($footer_fixed_checkbox)
        .append("<span>Mantener Pie de Página</span>");
    ...
    var navbar_dark_skins = getNavbarDarkSkins();

    var navbar_light_skins = getNavbarLightSkins();

    var sidebar_colors = getSidebarColors();

    var accent_colors = getAccentColors();

    var sidebar_skins = getSidebarSkins();

    $container.append("<h6>Variantes de Barra de Navegación</h6>");
